export const TRANSLATIONS_EN = {
  ...
  why: 'Why VolunGO?',
  sub_text_why:
    'VolunGO helps volunteers to find volunteer opportunities in their city quickly and easily',
  opportunities: 'Find volunteer opportunities',
  sub_text_opportunities:
    'Find volunteer opportunities that fit you in your city or ways to help from home when you’re free.',
  organizations: 'Join your local organizations',
  sub_text_organizations:
    'Join your local organizations who provide volunteer opportunities that are suit to you.',
  impact: 'Track your impact',
  sub_text_impact:
    'See all your individual impact (volunteer hours and organizations) at a glance.',

  //About us
  about_us: 'about us',
  sub_text_about_us:
    'We aim to bring like-minded people together to make humanitarian aid reach more populations',

  //sign up first page for Volunteers and NGO
  step1: 'step 1/3',
  account: 'Create Your Account',
  sub_text_account:
    'VolunGO is a platform for bringing volunteers and nonprofit organizations together.',
  email: 'E-mail',
  ...
  sub_text_about_you:
    'Genuine information helps us to find the best opportunities for you.',
  ...
  welcome_to_community:
    'Welecome to our volunteer community! Continue setting your preferences and get your feed more personalized.',
  ...
  sub_text_location_info:
    'Type the postal code of the location you would like to use to search for opportunities.',
  city: 'City (optional)',
  city_placeholder: 'Munich',
  postal_code: 'Postal code',
  postal_code_placeholder: 'e.g. 87671',
  terms_conditions:
    "By continuing, you confirm that you've read and agree to our Terms and Conditions and Privacy Policy.",
  ...
  sub_text_register_org:
    'This information will appear on your organization profile. Precise information helps users to find and join your opportunities.',
  ...
  sub_text_about_project:
    'Let’s start with filling in  the overall information on the project.',
  ...
  sub_text_location_time_info:
    'Fill in when and where your project takes place.',
  ...
  sub_text_invite_volunteers:
    'Lastly, invite volunteers who match to your new project. It helps you to reach out to the potential volunteers and accelerate your recruitment process.',
  ...
  sub_text_ngo_why_volungo:
    'VolunGO helps organizations to find the best volunteers who match to the projects',
  matching: 'Match the best volunteers in the city',
  sub_text_matching:
    'Fill the information about your organization and your projects. You receive only qualified volunteer matches based on their interests and abilities.',
  recruiting: 'Recruit volunteers for your opportunities',
  sub_text_recruiting:
    'Don’t want to wait? Send an automatic invitation right away to volunteers that might match your opportunity, or bring the volunteers you already have.',
  managing: 'Manage all projects in one place',
  sub_text_managing:
    'See all your projects and volunteers in one place. The best? You keep an organized database of projects and volunteers without any excel sheet.',
  ...
  sub_text_empty_dashboard:
    'Add you first project by clicking the button on the top right corner. We will guide you through the process.',
};
